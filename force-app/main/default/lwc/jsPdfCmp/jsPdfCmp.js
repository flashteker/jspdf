...
export default class JsPdfCmp extends LightningElement {
    ...
    */
    ...
    /**
    *  horizontal의 자식 뷰들을 강제로 테이블에 집어 넣어 그린다.
    */
    ...
    */
    drawImage(data, area){
        ...
        return {x:area.x, y:area.y, w:area.w, h:data.image.height + data.margin.top + data.margin.bottom};
    }
